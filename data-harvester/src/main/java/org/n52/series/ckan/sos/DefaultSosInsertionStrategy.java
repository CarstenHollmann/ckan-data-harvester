...
class DefaultSosInsertionStrategy implements SosInsertionStrategy {
    ...
    boolean insertOrUpdateData(DataTable dataTable, DataCollection dataCollection) {
        ...
        for (Entry<ResourceKey, Map<ResourceField, String>> rowEntry : dataTable.getTable().rowMap().entrySet()) {
            ...
            // TODO how to create a FOI for mobile sensors, what would be the identifier? same as procedure?
            ...
            for (Phenomenon phenomenon : phenomena) {
                InsertSensorRequestBuilder insertSensorRequestBuilder = new InsertSensorRequestBuilder(feature, phenomenon, dataset);
                ...
                if ( !dataInsertions.containsKey(procedureId)) {
                    ...
                    DataInsertion dataInsertion = new DataInsertion(insertSensorRequestBuilder.create(), feature);
